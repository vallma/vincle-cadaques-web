...
const I18N = {
  ...
  es: {
    ...
    'coc.title': 'El sabor del<br><em>Mediterráneo</em>',
    ...
    'dish.1': 'Plato icónico: morels con salsa de la abuela y polvo frío de foie de Paco Pérez',
  ...
  ca: {
    ...
    'coc.title': 'El sabor del<br><em>Mediterrani</em>',
    ...
    'dish.1': "Plat icònic: rossinyols amb salsa de l'àvia i polsim fred de foie de Paco Pérez",
  ...
  en: {
    ...
    'coc.title': 'The taste of the<br><em>Mediterranean</em>',
    ...
    'dish.1': "Signature dish: chanterelles with grandmother's sauce and Paco Pérez's cold foie powder",
  ...
  fr: {
    ...
    'coc.title': 'Le goût de la<br><em>Méditerranée</em>',
    ...
    'dish.1': 'Plat emblématique : girolles à la sauce de grand-mère et poudre froide de foie gras de Paco Pérez',
